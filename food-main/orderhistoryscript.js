...
async function loadDishes() {
    const API_URL = "http://lab8-api.std-900.ist.mospolytech.ru/labs/api/dishes?api_key=df697bfb-c4c3-4054-8f19-b209e471c0df";
...
async function loadOrders() {
    const API_URL = "http://lab8-api.std-900.ist.mospolytech.ru/labs/api/orders?api_key=df697bfb-c4c3-4054-8f19-b209e471c0df";
...
async function deleteOrder (row, orderID) {
    ...
    const API_URL = `http://lab8-api.std-900.ist.mospolytech.ru/labs/api/orders/${orderID}?api_key=df697bfb-c4c3-4054-8f19-b209e471c0df`;
